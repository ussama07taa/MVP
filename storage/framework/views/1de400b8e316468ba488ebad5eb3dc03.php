...
<body>
    ...
    <div class="header">
        <div class="company-info">
            <div class="logo">
                ...
                <?php if(isset($settings['company_logo']) && $settings['company_logo']): ?>
                    <img src="<?php echo e(public_path('storage/' . $settings['company_logo'])); ?>" style="width: 80px;">
                <?php else: ?>
                    <div style="width: 80px; height: 80px; background: #0f172a; border-radius: 15px;"></div>
                <?php endif; ?>
            </div>
            <div class="company-details">
                <h1 class="company-name"><?php echo e($settings['company_name'] ?? 'TAAOUATI'); ?></h1>
                <div class="company-sub">
                    <?php echo e($settings['company_phone'] ?? '+212 666-035411 / +212 610-182585'); ?><br>
                    <?php echo e($settings['company_address'] ?? 'TANGER JAMA3 ALRB3IN'); ?>
        ...
        <div class="invoice-type">
            <div class="status-badge">
                <?php echo e($rb <= 0.01 ? 'PAYÉ' : 'PAIEMENT EN ATTENTE'); ?>

            </div>
            <h2 class="type-label"><?php echo e(strtoupper($invoice->type === 'quote' ? 'DEVIS' : 'FACTURE')); ?></h2>
            <div class="ref-label"><?php echo e(str_starts_with($invoice->invoice_number, '#') ? '' : '#'); ?><?php echo e($invoice->invoice_number); ?></div>
            <div class="date-label"><?php echo e($invoice->issue_date->format('d \m\a\i Y \à H:i')); ?></div>
        </div>
        <div class="clear"></div>
    </div>
    ...
    <div class="container">
        <div class="client-section">
            ...
            <div class="client-box">
                <div class="client-name"><?php echo e($invoice->client->name); ?></div>
                <div class="client-phone"><?php echo e($invoice->client->phone); ?></div>
            </div>
            
            <div class="meta-box">
                <div class="meta-row">
                    <span class="meta-label">Réf.</span>
                    <span class="meta-value"><?php echo e(str_starts_with($invoice->invoice_number, '#') ? '' : '#'); ?><?php echo e($invoice->invoice_number); ?></span>
                </div>
                <div class="meta-row">
                    <span class="meta-label">Émis le</span>
                    <span class="meta-value"><?php echo e($invoice->issue_date->format('d \m\a\i Y')); ?></span>
                </div>
            </div>
            <div class="clear"></div>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-num"><?php echo e(str_pad($rowNum++, 2, '0', STR_PAD_LEFT)); ?></td>
                    <td class="col-desc"><?php echo e(strtoupper($item['description'])); ?></td>
                    <td class="col-qty">x<?php echo e((float)$item['quantity']); ?></td>
                    <td class="col-price"><?php echo e(number_format($item['unit_price'], 2)); ?></td>
                    <td class="col-total"><?php echo e(number_format($item['total'], 2)); ?> DH</td>
                </tr>
        ...
        <div class="summary-section">
            ...
            <div class="totals-box">
                <div class="total-row">
                    ...
                    <span class="total-value"><?php echo e(number_format($invoice->subtotal, 2)); ?> DH</span>
                </div>
                
                <div class="total-row" style="margin-top: 10px;">
                    <span class="total-main-label">TOTAL À PAYER</span>
                    <span class="total-main-value"><?php echo e(number_format($invoice->total, 2)); ?> DH</span>
                </div>
                
                <div class="total-row">
                    <span class="total-label avance-label">AVANCE</span>
                    <span class="total-value avance-value">- <?php echo e(number_format($invoice->amount_paid, 2)); ?> DH</span>
                </div>
                
                <div class="total-row reste-box">
                    <span class="reste-label">RESTE DÛ</span>
                    <span class="reste-value"><?php echo e(number_format($rb, 2)); ?> DH</span>
                </div>
                <div class="clear"></div>
            </div>
            <div class="clear"></div>
    ...
    <div class="footer">
        <div class="footer-ice">ICE: <?php echo e($settings['company_ice'] ?? '122-2333'); ?></div>
        <div class="footer-thanks">MERCI POUR VOTRE CONFIANCE !</div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\Taaouati\Downloads\MVP\resources\views/pdf/invoice.blade.php ENDPATH**/ ?>